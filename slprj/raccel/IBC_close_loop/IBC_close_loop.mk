###########################################################################
## Makefile generated for component 'IBC_close_loop'. 
## 
## Makefile     : IBC_close_loop.mk
## Generated on : Wed Apr 28 16:12:20 2021
## Final product: ./IBC_close_loop.exe
...
COMPILER_COMMAND_FILE     = IBC_close_loop_comp.rsp
CMD_FILE                  = IBC_close_loop.rsp
...
DEFINES_STANDARD = -DMODEL=IBC_close_loop -DNUMST=3 -DNCSTATES=4 -DHAVESTDIO
...
%.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
IBC_close_loop.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/IBC_close_loop.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IBC_close_loop_capi.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/IBC_close_loop_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IBC_close_loop_data.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/IBC_close_loop_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IBC_close_loop_tgtconn.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/IBC_close_loop_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/IBC_close_loop/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
