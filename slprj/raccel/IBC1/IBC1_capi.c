...
"IBC1/命令信号生产/Relational Operator" ) , TARGET_STRING ( "" ) , 0 , 1 , 0
, 0 , 3 } , { 11 , 0 , TARGET_STRING (
"IBC1/命令信号生产/Relational Operator1" ) , TARGET_STRING ( "" ) , 0 , 1 , 0
, 0 , 3 } , { 12 , 0 , TARGET_STRING (
"IBC1/命令信号生产/Relational Operator2" ) , TARGET_STRING ( "" ) , 0 , 1 , 0
, 0 , 3 } , { 13 , 0 , TARGET_STRING ( "IBC1/命令信号生产/Transport Delay" )
, TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 14 , 0 , TARGET_STRING (
"IBC1/命令信号生产/Transport Delay1" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0
, 2 } , { 15 , 0 , TARGET_STRING ( "IBC1/命令信号生产/Transport Delay2" ) ,
...
"IBC1/命令信号生产/Repeating Sequence/Output" ) , TARGET_STRING ( "" ) , 0 ,
0 , 0 , 0 , 2 } , { 27 , 0 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence1/Look-Up Table1" ) , TARGET_STRING ( ""
) , 0 , 0 , 0 , 0 , 2 } , { 28 , 0 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence2/Look-Up Table1" ) , TARGET_STRING ( ""
) , 0 , 0 , 0 , 0 , 2 } , { 29 , 0 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence4/Output" ) , TARGET_STRING ( "" ) , 0 ,
...
"IBC1/命令信号生产" ) , TARGET_STRING ( "Fs" ) , 0 , 0 , 0 } , { 47 ,
...
, { 67 , TARGET_STRING ( "IBC1/命令信号生产/Repeating Sequence" ) ,
TARGET_STRING ( "rep_seq_y" ) , 0 , 6 , 0 } , { 68 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence1" ) , TARGET_STRING ( "rep_seq_y" ) , 0
, 6 , 0 } , { 69 , TARGET_STRING ( "IBC1/命令信号生产/Repeating Sequence2" )
, TARGET_STRING ( "rep_seq_y" ) , 0 , 6 , 0 } , { 70 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence4" ) , TARGET_STRING ( "rep_seq_y" ) , 0
, 6 , 0 } , { 71 , TARGET_STRING ( "IBC1/命令信号生产/Transport Delay" ) ,
TARGET_STRING ( "DelayTime" ) , 0 , 0 , 0 } , { 72 , TARGET_STRING (
"IBC1/命令信号生产/Transport Delay" ) , TARGET_STRING ( "InitialOutput" ) , 0
, 0 , 0 } , { 73 , TARGET_STRING ( "IBC1/命令信号生产/Transport Delay1" ) ,
TARGET_STRING ( "InitialOutput" ) , 0 , 0 , 0 } , { 74 , TARGET_STRING (
"IBC1/命令信号生产/Transport Delay2" ) , TARGET_STRING ( "InitialOutput" ) ,
...
"IBC1/命令信号生产/Compare To Zero/Constant" ) , TARGET_STRING ( "Value" ) ,
0 , 0 , 0 } , { 89 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence/Constant" ) , TARGET_STRING ( "Value" )
, 0 , 0 , 0 } , { 90 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence/Look-Up Table1" ) , TARGET_STRING (
"BreakpointsForDimension1" ) , 0 , 6 , 0 } , { 91 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence1/Constant" ) , TARGET_STRING ( "Value"
) , 0 , 0 , 0 } , { 92 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence1/Look-Up Table1" ) , TARGET_STRING (
"BreakpointsForDimension1" ) , 0 , 6 , 0 } , { 93 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence2/Constant" ) , TARGET_STRING ( "Value"
) , 0 , 0 , 0 } , { 94 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence2/Look-Up Table1" ) , TARGET_STRING (
"BreakpointsForDimension1" ) , 0 , 6 , 0 } , { 95 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence4/Constant" ) , TARGET_STRING ( "Value"
) , 0 , 0 , 0 } , { 96 , TARGET_STRING (
"IBC1/命令信号生产/Repeating Sequence4/Look-Up Table1" ) , TARGET_STRING (
