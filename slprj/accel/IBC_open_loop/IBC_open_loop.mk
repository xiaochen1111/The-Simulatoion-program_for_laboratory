###########################################################################
## Makefile generated for component 'IBC_open_loop'. 
## 
## Makefile     : IBC_open_loop.mk
## Generated on : Sat Apr 24 15:18:27 2021
## Final product: ./IBC_open_loop_acc.lib
...
COMPILER_COMMAND_FILE     = IBC_open_loop_comp.rsp
CMD_FILE                  = IBC_open_loop.rsp
...
DEFINES_STANDARD = -DMODEL=IBC_open_loop -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
%.obj : $(START_DIR)/slprj/accel/IBC_open_loop/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/IBC_open_loop/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
