#ifndef RTW_HEADER_IBC_open_loop_acc_private_h_
#define RTW_HEADER_IBC_open_loop_acc_private_h_
#include "rtwtypes.h"
...
int_T * maxNewBufSzPtr ) ; real_T IBC_open_loop_acc_rt_TDelayInterpolate (
...
uint32_T maxIndex ) ; void IBC_open_loop_SampleIL1_Init ( SimStruct * S ,
B_SampleIL1_IBC_open_loop_T * localB , P_SampleIL1_IBC_open_loop_T * localP )
; void IBC_open_loop_SampleIL1 ( SimStruct * S , boolean_T rtu_Trigger ,
real_T rtu_In , B_SampleIL1_IBC_open_loop_T * localB ,
DW_SampleIL1_IBC_open_loop_T * localDW , ZCE_SampleIL1_IBC_open_loop_T *
localZCE ) ; void IBC_open_loop_SampleIL1_Term ( SimStruct * const S ) ;
#endif
