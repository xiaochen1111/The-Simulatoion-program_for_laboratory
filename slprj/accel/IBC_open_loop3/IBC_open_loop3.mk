###########################################################################
## Makefile generated for component 'IBC_open_loop3'. 
## 
## Makefile     : IBC_open_loop3.mk
## Generated on : Fri May 28 20:33:17 2021
## Final product: ./IBC_open_loop3_acc.lib
...
COMPILER_COMMAND_FILE     = IBC_open_loop3_comp.rsp
CMD_FILE                  = IBC_open_loop3.rsp
...
PRODUCT = ./IBC_open_loop3_acc.lib
...
DEFINES_STANDARD = -DMODEL=IBC_open_loop3 -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
%.obj : $(START_DIR)/slprj/accel/IBC_open_loop3/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/IBC_open_loop3/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
