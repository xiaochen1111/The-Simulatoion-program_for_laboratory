...
#endif
boolean_T IBC1_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T * bufSzPtr , int_T *
...
IBC1_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart , real_T *
...
IBC1_SampleandHold_Init ( SimStruct * S , B_SampleandHold_IBC1_T * localB ,
P_SampleandHold_IBC1_T * localP ) { localB -> B_0_0_0 = localP -> P_0 ; }
void IBC1_SampleandHold ( SimStruct * S , boolean_T rtu_Trigger , real_T
rtu_In , B_SampleandHold_IBC1_T * localB , DW_SampleandHold_IBC1_T * localDW
, ZCE_SampleandHold_IBC1_T * localZCE ) { if ( ssIsMajorTimeStep ( S ) != 0 )
...
IBC1_SampleandHold_Term ( SimStruct * const S ) { } static void mdlOutputs (
SimStruct * S , int_T tid ) { boolean_T B_2_13_0 ; B_IBC1_T * _rtB ;
DW_IBC1_T * _rtDW ; P_IBC1_T * _rtP ; PrevZCX_IBC1_T * _rtZCE ; X_IBC1_T *
_rtX ; real_T rtb_B_2_15_0 ; real_T tmp ; int32_T isHit ; _rtDW = ( (
DW_IBC1_T * ) ssGetRootDWork ( S ) ) ; _rtZCE = ( ( PrevZCX_IBC1_T * )
_ssGetPrevZCSigState ( S ) ) ; _rtX = ( ( X_IBC1_T * ) ssGetContStates ( S )
) ; _rtP = ( ( P_IBC1_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( ( B_IBC1_T * )
_ssGetModelBlockIO ( S ) ) ; isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit
!= 0 ) { ssCallAccelRunBlock ( S , 2 , 0 , SS_CALL_MDL_OUTPUTS ) ; _rtB ->
B_2_1_0 = _rtP -> P_11 * _rtB -> B_2_0_0 [ 9 ] ; ssCallAccelRunBlock ( S , 2
, 2 , SS_CALL_MDL_OUTPUTS ) ; } _rtB -> B_2_7_0 = look1_binlxpw (
muDoubleScalarRem ( ssGetT ( S ) - _rtB -> B_2_4_0 , _rtB -> B_2_7_0_c ) ,
_rtP -> P_13 , _rtP -> P_12 , 2U ) ; { real_T * * uBuffer = ( real_T * * ) &
_rtDW -> TransportDelay1_PWORK . TUbufferPtrs [ 0 ] ; real_T simTime = ssGetT
( S ) ; real_T tMinusDelay = simTime - _rtP -> P_14 ; _rtB -> B_2_8_0 =
IBC1_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * uBuffer , _rtDW ->
...
-> B_2_9_0 = IBC1_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * uBuffer ,
...
== IBC1_rtC ( S ) -> B_2_0_0 ) ; } B_2_13_0 = _rtDW -> Compare_Mode ;
IBC1_SampleandHold ( S , B_2_13_0 , _rtB -> B_2_1_0 , & _rtB ->
SampleandHold1 , & _rtDW -> SampleandHold1 , & _rtZCE -> SampleandHold1 ) ;
rtb_B_2_15_0 = _rtB -> B_2_1_0_c - _rtB -> SampleandHold1 . B_0_0_0 ; _rtB ->
B_2_16_0 = _rtP -> P_20 * rtb_B_2_15_0 ; } _rtB -> B_2_17_0 = _rtX ->
Integrator_CSTATE ; _rtB -> B_2_18_0 = _rtB -> B_2_16_0 + _rtB -> B_2_17_0 ;
if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Saturation1_MODE = _rtB ->
B_2_18_0 >= _rtP -> P_22 ? 1 : _rtB -> B_2_18_0 > _rtP -> P_23 ? 0 : - 1 ; }
_rtB -> B_2_19_0 = _rtDW -> Saturation1_MODE == 1 ? _rtP -> P_22 : _rtDW ->
...
isHit != 0 ) { IBC1_SampleandHold ( S , B_2_13_0 , _rtB -> B_2_20_0 , & _rtB
...
-> B_2_127_0 = IBC1_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * uBuffer
...
} static void mdlOutputsTID3 ( SimStruct * S , int_T tid ) { B_IBC1_T * _rtB
; P_IBC1_T * _rtP ; _rtP = ( ( P_IBC1_T * ) ssGetModelRtp ( S ) ) ; _rtB = (
( B_IBC1_T * ) _ssGetModelBlockIO ( S ) ) ; memcpy ( & _rtB -> B_2_0_0_m [ 0
] , & _rtP -> P_55 [ 0 ] , 9U * sizeof ( real_T ) ) ; _rtB -> B_2_1_0_c =
_rtP -> P_56 ; _rtB -> B_2_2_0 = _rtP -> P_57 ; _rtB -> B_2_3_0 = _rtP ->
P_58 ; _rtB -> B_2_4_0_k = _rtP -> P_59 ; _rtB -> B_2_5_0 = _rtP -> P_60 ;
_rtB -> B_2_6_0 = _rtP -> P_61 ; _rtB -> B_2_7_0_c = _rtP -> P_62 ; _rtB ->
B_2_8_0_b = _rtP -> P_63 ; _rtB -> B_2_9_0_p = _rtP -> P_64 ; _rtB ->
B_2_10_0 = _rtP -> P_65 ; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { B_IBC1_T * _rtB ;
DW_IBC1_T * _rtDW ; P_IBC1_T * _rtP ; int32_T isHit ; _rtDW = ( ( DW_IBC1_T *
) ssGetRootDWork ( S ) ) ; _rtP = ( ( P_IBC1_T * ) ssGetModelRtp ( S ) ) ;
_rtB = ( ( B_IBC1_T * ) _ssGetModelBlockIO ( S ) ) ; isHit = ssIsSampleHit (
S , 2 , 0 ) ; if ( isHit != 0 ) { ssCallAccelRunBlock ( S , 2 , 0 ,
...
( ! IBC1_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW -> TransportDelay1_IWORK
...
( ! IBC1_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW -> TransportDelay2_IWORK
...
IBC1_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW -> TransportDelay_IWORK .
...
static void mdlDerivatives ( SimStruct * S ) { B_IBC1_T * _rtB ; P_IBC1_T *
_rtP ; XDot_IBC1_T * _rtXdot ; X_IBC1_T * _rtX ; _rtXdot = ( ( XDot_IBC1_T *
) ssGetdX ( S ) ) ; _rtX = ( ( X_IBC1_T * ) ssGetContStates ( S ) ) ; _rtP =
( ( P_IBC1_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( ( B_IBC1_T * )
_ssGetModelBlockIO ( S ) ) ; _rtXdot -> Integrator_CSTATE = _rtB -> B_2_115_0
; _rtXdot -> Integrator_CSTATE_e = _rtB -> B_2_114_0 ; _rtXdot ->
TransferFcn1_CSTATE [ 0 ] = 0.0 ; _rtXdot -> TransferFcn1_CSTATE [ 0 ] +=
_rtP -> P_53 [ 0 ] * _rtX -> TransferFcn1_CSTATE [ 0 ] ; _rtXdot ->
TransferFcn1_CSTATE [ 1 ] = 0.0 ; _rtXdot -> TransferFcn1_CSTATE [ 0 ] +=
_rtP -> P_53 [ 1 ] * _rtX -> TransferFcn1_CSTATE [ 1 ] ; _rtXdot ->
TransferFcn1_CSTATE [ 1 ] += _rtX -> TransferFcn1_CSTATE [ 0 ] ; _rtXdot ->
TransferFcn1_CSTATE [ 0 ] += _rtB -> B_2_135_0 ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { B_IBC1_T * _rtB ; P_IBC1_T *
_rtP ; ZCV_IBC1_T * _rtZCSV ; _rtZCSV = ( ( ZCV_IBC1_T * )
ssGetSolverZcSignalVector ( S ) ) ; _rtP = ( ( P_IBC1_T * ) ssGetModelRtp ( S
) ) ; _rtB = ( ( B_IBC1_T * ) _ssGetModelBlockIO ( S ) ) ; _rtZCSV ->
Compare_RelopInput_ZC = _rtB -> B_2_7_0 - IBC1_rtC ( S ) -> B_2_0_0 ; _rtZCSV
...
, 2790053004U ) ; ssSetChecksumVal ( S , 1 , 689975080U ) ; ssSetChecksumVal
( S , 2 , 4055452918U ) ; ssSetChecksumVal ( S , 3 , 613630192U ) ; { mxArray
...
S ) != sizeof ( DW_IBC1_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_IBC1_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_IBC1_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & IBC1_rtDefaultP ) ; _ssSetConstBlockIO ( S , & IBC1_rtInvariant ) ;
