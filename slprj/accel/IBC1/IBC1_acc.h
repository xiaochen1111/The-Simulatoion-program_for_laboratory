#ifndef RTW_HEADER_IBC1_acc_h_
#define RTW_HEADER_IBC1_acc_h_
#include <stddef.h>
#include <float.h>
#include <string.h>
#ifndef IBC1_acc_COMMON_INCLUDES_
#define IBC1_acc_COMMON_INCLUDES_
#include <stdlib.h>
...
#endif
#include "IBC1_acc_types.h"
#include "multiword_types.h"
#include "mwmathutil.h"
#include "rt_defines.h"
#include "rt_nonfinite.h"
typedef struct { real_T B_0_0_0 ; } B_SampleandHold_IBC1_T ; typedef struct {
int32_T SampleandHold_sysIdxToRun ; int8_T SampleandHold_SubsysRanBC ; char_T
pad_SampleandHold_SubsysRanBC [ 3 ] ; } DW_SampleandHold_IBC1_T ; typedef
struct { real_T SampleandHold_Trig_ZC ; } ZCV_SampleandHold_IBC1_T ; typedef
struct { ZCSigState SampleandHold_Trig_ZCE ; } ZCE_SampleandHold_IBC1_T ;
...
pad_B_2_29_0 [ 5 ] ; B_SampleandHold_IBC1_T SampleandHold1 ;
B_SampleandHold_IBC1_T SampleandHold ; } B_IBC1_T ; typedef struct { real_T
...
DW_SampleandHold_IBC1_T SampleandHold1 ; DW_SampleandHold_IBC1_T
SampleandHold ; } DW_IBC1_T ; typedef struct { real_T Integrator_CSTATE ;
real_T Integrator_CSTATE_e ; real_T TransferFcn1_CSTATE [ 2 ] ; } X_IBC1_T ;
typedef struct { real_T Integrator_CSTATE ; real_T Integrator_CSTATE_e ;
real_T TransferFcn1_CSTATE [ 2 ] ; } XDot_IBC1_T ; typedef struct { boolean_T
Integrator_CSTATE ; boolean_T Integrator_CSTATE_e ; boolean_T
TransferFcn1_CSTATE [ 2 ] ; } XDis_IBC1_T ; typedef struct { real_T
Integrator_CSTATE ; real_T Integrator_CSTATE_e ; real_T TransferFcn1_CSTATE [
2 ] ; } CStateAbsTol_IBC1_T ; typedef struct { real_T Integrator_CSTATE ;
real_T Integrator_CSTATE_e ; real_T TransferFcn1_CSTATE [ 2 ] ; }
CXPtMin_IBC1_T ; typedef struct { real_T Integrator_CSTATE ; real_T
Integrator_CSTATE_e ; real_T TransferFcn1_CSTATE [ 2 ] ; } CXPtMax_IBC1_T ;
...
; real_T Step_StepTime_ZC ; ZCV_SampleandHold_IBC1_T SampleandHold1 ;
ZCV_SampleandHold_IBC1_T SampleandHold ; } ZCV_IBC1_T ; typedef struct {
...
ZCE_SampleandHold_IBC1_T SampleandHold1 ; ZCE_SampleandHold_IBC1_T
SampleandHold ; } PrevZCX_IBC1_T ; typedef struct { const real_T B_2_0_0 ; }
ConstB_IBC1_T ;
#define IBC1_rtC(S) ((ConstB_IBC1_T *) _ssGetConstBlockIO(S))
struct P_SampleandHold_IBC1_T_ { real_T P_0 ; } ; struct P_IBC1_T_ { real_T
P_0 ; real_T P_1 [ 2 ] ; real_T P_2 [ 16 ] ; real_T P_3 [ 2 ] ; real_T P_4 [
52 ] ; real_T P_5 [ 2 ] ; real_T P_6 [ 68 ] ; real_T P_7 [ 2 ] ; real_T P_8 [
221 ] ; real_T P_9 [ 2 ] ; real_T P_10 [ 4 ] ; real_T P_11 ; real_T P_12 [ 3
] ; real_T P_13 [ 3 ] ; real_T P_14 ; real_T P_15 ; real_T P_16 ; real_T P_17
; real_T P_18 ; real_T P_19 ; real_T P_20 ; real_T P_21 ; real_T P_22 ;
...
P_39 ; real_T P_40 [ 3 ] ; real_T P_41 [ 3 ] ; real_T P_42 [ 3 ] ; real_T
P_43 [ 3 ] ; real_T P_44 ; real_T P_45 ; real_T P_46 [ 3 ] ; real_T P_47 [ 3
] ; real_T P_48 ; real_T P_49 ; real_T P_50 ; real_T P_51 ; real_T P_52 ;
real_T P_53 [ 2 ] ; real_T P_54 [ 2 ] ; real_T P_55 [ 9 ] ; real_T P_56 ;
real_T P_57 ; real_T P_58 ; real_T P_59 ; real_T P_60 ; real_T P_61 ; real_T
P_62 ; real_T P_63 ; real_T P_64 ; real_T P_65 ; P_SampleandHold_IBC1_T
SampleandHold1 ; P_SampleandHold_IBC1_T SampleandHold ; } ; extern P_IBC1_T
IBC1_rtDefaultP ; extern const ConstB_IBC1_T IBC1_rtInvariant ;
#endif
