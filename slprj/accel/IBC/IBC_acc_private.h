#ifndef RTW_HEADER_IBC_acc_private_h_
#define RTW_HEADER_IBC_acc_private_h_
#include "rtwtypes.h"
...
maxNewBufSzPtr ) ; real_T IBC_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
...
P_SampleandHold_IBC_T * localP ) ; void IBC_SampleandHold ( SimStruct * S ,
boolean_T rtu_Trigger , real_T rtu_In , B_SampleandHold_IBC_T * localB ,
DW_SampleandHold_IBC_T * localDW , ZCE_SampleandHold_IBC_T * localZCE ) ;
void IBC_SampleandHold_Term ( SimStruct * const S ) ;
#endif
