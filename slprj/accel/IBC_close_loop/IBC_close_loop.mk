...
## Generated on : Wed Apr 28 16:14:50 2021
## Final product: ./IBC_close_loop_acc.lib
...
PRODUCT = ./IBC_close_loop_acc.lib
...
DEFINES_STANDARD = -DMODEL=IBC_close_loop -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
%.obj : $(START_DIR)/slprj/accel/IBC_close_loop/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/IBC_close_loop/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
