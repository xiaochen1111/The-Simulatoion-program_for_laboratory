###########################################################################
## Makefile generated for component 'IBC_close_loop2'. 
## 
## Makefile     : IBC_close_loop2.mk
## Generated on : Wed Apr 28 16:19:27 2021
## Final product: ./IBC_close_loop2_acc.lib
...
COMPILER_COMMAND_FILE     = IBC_close_loop2_comp.rsp
CMD_FILE                  = IBC_close_loop2.rsp
...
PRODUCT = ./IBC_close_loop2_acc.lib
...
DEFINES_STANDARD = -DMODEL=IBC_close_loop2 -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
%.obj : $(START_DIR)/slprj/accel/IBC_close_loop2/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/IBC_close_loop2/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
