###########################################################################
## Makefile generated for component 'IBC_open_loop2'. 
## 
## Makefile     : IBC_open_loop2.mk
## Generated on : Sun May 30 09:28:14 2021
## Final product: ./IBC_open_loop2_acc.lib
...
COMPILER_COMMAND_FILE     = IBC_open_loop2_comp.rsp
CMD_FILE                  = IBC_open_loop2.rsp
...
PRODUCT = ./IBC_open_loop2_acc.lib
...
DEFINES_STANDARD = -DMODEL=IBC_open_loop2 -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
%.obj : $(START_DIR)/slprj/accel/IBC_open_loop2/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/IBC_open_loop2/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
